...
@objc public class SwipeNavigationController: UIViewController {
     ...
     */
    @IBOutlet public var currentXOffset: NSLayoutConstraint!
    ...
    open var shouldShowRightViewController = false
